...
void Vhdmi_driver::traceChgThis__2(Vhdmi_driver__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus(c+1,(vlTOPp->hdmi_driver__DOT__I2C_0__DOT__next_state),5);
    }
}
...
void Vhdmi_driver::traceChgThis__3(Vhdmi_driver__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus(c+2,(((IData)(vlTOPp->hdmi_driver__DOT__I2C_0__DOT__address)
...
void Vhdmi_driver::traceChgThis__4(Vhdmi_driver__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus(c+3,(vlTOPp->hdmi_driver__DOT__data),8);
    }
}
...
void Vhdmi_driver::traceChgThis__6(Vhdmi_driver__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit(c+7,(vlTOPp->hdmi_driver__DOT__done));
	vcdp->chgBus(c+8,(vlTOPp->hdmi_driver__DOT__I2C_0__DOT__counter),4);
	vcdp->chgBus(c+9,(vlTOPp->hdmi_driver__DOT__I2C_0__DOT__state),5);
	vcdp->chgBit(c+10,(vlTOPp->hdmi_driver__DOT__I2C_0__DOT__ack));
	vcdp->chgBus(c+11,(vlTOPp->hdmi_driver__DOT__I2C_0__DOT__byte_num_local),3);
	vcdp->chgBit(c+12,(vlTOPp->hdmi_driver__DOT__I2C_0__DOT__address));
    }
}
...
void Vhdmi_driver::traceChgThis__7(Vhdmi_driver__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus(c+13,(vlTOPp->hdmi_driver__DOT__byte_lut_next),8);
    }
}
...
void Vhdmi_driver::traceChgThis__8(Vhdmi_driver__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBus(c+14,(vlTOPp->hdmi_driver__DOT__byte_lut),8);
    }
}
...
void Vhdmi_driver::traceChgThis__9(Vhdmi_driver__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
	vcdp->chgBit(c+15,(vlTOPp->clk_50));
	...
	vcdp->chgBit(c+25,(vlTOPp->scl));
	vcdp->chgBit(c+26,(vlTOPp->sda));
	vcdp->chgBit(c+27,(vlTOPp->fail));
	vcdp->chgBit(c+28,(vlTOPp->rst));
	vcdp->chgBit(c+29,(vlTOPp->clk_25));
	vcdp->chgBit(c+30,(vlTOPp->HDMI_INT));
	vcdp->chgBit(c+31,(vlTOPp->mI2C_CTRL_CLK));
	vcdp->chgBit(c+32,((1U & (~ (IData)(vlTOPp->reset_al)))));
    }
}
