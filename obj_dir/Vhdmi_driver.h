...
VL_MODULE(Vhdmi_driver) {
  public:
    ...
    VL_SIG8(hdmi_driver__DOT__mI2C_CTRL_CLK,0,0);
    ...
    // Internals; generally not touched by application code
    // Begin mtask footprint  all: 
    VL_SIG8(hdmi_driver__DOT__sda__out__out0,0,0);
    VL_SIG8(__Vtableidx1,7,0);
    VL_SIG8(__Vdly__hdmi_driver__DOT__byte_lut_next,7,0);
    VL_SIG8(__VinpClk__TOP__clk_25,0,0);
    VL_SIG8(__VinpClk__TOP__hdmi_driver__DOT__mI2C_CTRL_CLK,0,0);
    ...
    VL_SIG8(__Vclklast__TOP____VinpClk__TOP__hdmi_driver__DOT__mI2C_CTRL_CLK,0,0);
    ...
    VL_SIG8(__Vchglast__TOP__hdmi_driver__DOT__mI2C_CTRL_CLK,0,0);
  ...
  public:
    ...
    static void _multiclk__TOP__8(Vhdmi_driver__Syms* __restrict vlSymsp);
    ...
    static void _sequent__TOP__7(Vhdmi_driver__Syms* __restrict vlSymsp);
