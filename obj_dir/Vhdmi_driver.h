...
VL_MODULE(Vhdmi_driver) {
  public:
    ...
    VL_SIG8(__VinpClk__TOP__hdmi_driver__DOT__clk_50k,0,0);
    VL_SIG8(__VinpClk__TOP__hdmi_driver__DOT__done,0,0);
    VL_SIG8(__Vclklast__TOP__clk_25,0,0);
    VL_SIG8(__Vclklast__TOP____VinpClk__TOP__hdmi_driver__DOT__clk_50k,0,0);
    VL_SIG8(__Vclklast__TOP____VinpClk__TOP__hdmi_driver__DOT__done,0,0);
    VL_SIG8(__Vchglast__TOP__hdmi_driver__DOT__clk_50k,0,0);
  ...
  public:
    ...
    static void _multiclk__TOP__6(Vhdmi_driver__Syms* __restrict vlSymsp);
